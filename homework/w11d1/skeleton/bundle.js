...
document.addEventListener('DOMContentLoaded', function () {
  var store = Object(_store_store__WEBPACK_IMPORTED_MODULE_2__["default"])(); // window.fetchSearchGiphys = fetchSearchGiphys;
...
var YOUR_GIPHY_API_KEY = "xCiZQCOqVed094kTUGxAFalvNqF5nXRb";
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=").concat(YOUR_GIPHY_API_KEY, "&limit=2")
  });
};
