# What do we test in our models?
    # validations
    # associations
    # public methods
# `password=` is tested implicitly by our password validation test
# private methods are tested implicitly by our public methods
# When writing tests, think about the core responsibility for each method
